"""
리딩레이스 4단계 도서 목록 수집 스크립트
=====================================================
대상: https://rd.dreamschool.or.kr/reading/certmain?field_id=&level=4&sc=regdate
저장: reading_race_books (level='4')

동작:
  1. 드림스쿨 홈페이지 4단계 목록 크롤링 (전체 페이지)
...
def parse_page(page_num: int) -> tuple[list[dict], int]:
    ...
    # 전체 페이지 수 파싱 ("총 715개, 쪽번호 1/30" 형식)
    total_pages = 1
