// src/pages/OmokBattleRanking.jsx
...
export default function OmokBattleRanking() {
  ...
  useEffect(() => {
    const run = async () => {
      ...
      try {
        ...
        console.error("omok battle ranking load error:", e);
    ...
    <div className="ranking-page">
      <header className="top-header">
        <div className="top-row">
          <button type="button" className="ranking-nav-btn" onClick={() => navigate("/omok-battle")}>오목대전으로</button>
          <h1 className="app-title">오목대전 랭킹</h1>
      ...
      {loading ? (
        ...
        <div className="ranking-section">
          <div className="ranking-section-title">15×15 대전</div>
      ...
      <div className="ranking-tip ranking-tip-spaced">
        <button type="button" className="hanja-btn ghost ranking-back-btn" onClick={() => navigate("/omok-battle")}>오목대전으로 돌아가기</button>
      </div>
    </div>
  );
}
